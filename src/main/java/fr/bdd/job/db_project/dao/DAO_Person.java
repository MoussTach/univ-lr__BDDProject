...
public class DAO_Person implements Dao<Person> {
    ...
    /**
     * Default constructor.
     * Need to call {@link DAO_Person#setConnection(DataConnection)} before any other function.
     *
     * @author Gaetan Brenckle
     */
    public DAO_Person() {
     ...
     */
    public DAO_Person(DataConnection conn) throws InvalidKeyException {
     ...
     */
    public final Person select(Integer id) throws SQLException, InvalidKeyException {
     ...
     * @throws InvalidKeyException - throw this exception when the given list dont have the key wanted
     */
    public final List<Person> selectByMultiCondition(HashMap<String, String> map) throws SQLException, InvalidKeyException {
     ...
     */
    @Override
    public List<Person> selectAll() throws SQLException, InvalidKeyException {
        final List<Person> retCategories = new ArrayList<>();
    ...
    @Override
    public List<Person> selectAll(List<Person> excludeList) throws SQLException, InvalidKeyException {
        return null;
    }
     ...
     */
    @Override
    public boolean insert(Person obj) throws SQLException, InvalidKeyException {
     ...
     */
    @Override
    public boolean update(Person obj) throws SQLException, InvalidKeyException {
        boolean retBool = true;
    ...
    @Override
    public boolean upsert(Person obj) throws SQLException, InvalidKeyException {
        return false;
    }
