package fr.bdd.custom.remastered.controls.text;

import de.saxsys.mvvmfx.utils.validation.ValidationStatus;
import fr.bdd.custom.fixer.TooltipDefaultFixer;
 ...
 */
public class CustomTextField_R extends TextField {
     ...
     *
     * @see CustomTextField_R#CustomTextField_R()
     */
    public CustomTextField_R(String text) {
        this();
        super.setText(text);
    }
