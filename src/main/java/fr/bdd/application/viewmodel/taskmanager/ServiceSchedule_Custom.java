 ...
 */
public abstract class ServiceSchedule_Custom<T> extends ScheduledService<T> implements ThreadFunctions<T> {
     ...
     */
    public ServiceSchedule_Custom setDelayUntilStart(Duration delayUntilStart_) {
     ...
     * @return - {@link ServiceSchedule_Custom} - builder pattern.
     */
    public ServiceSchedule_Custom setStepDurationOnFail(Duration stepDurationOnFail_) {
